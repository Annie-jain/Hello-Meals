...
<body background="backg28.jpg">
<h2><a href="index.html">home</a></h2>
<div style="position:absolute;left:35%;top:-4%"><h3>chef choices</h3></div>
<div style="position:absolute;left:70%;top:8%">
<img src="images copy/p.png" width=400>
</div>
<div style="position:absolute;left:70%;top:57%">
<img src="images copy/emenu11.png" width=400 >
</div>
<div style="position:absolute;left:5%;top:87%">
<img src="images copy/emenu4.png" width=300>
</div>
<div style="position:absolute;left:1%;top:6%">
<img src="images copy/alogo.png" width=400>
</div>
<div style="position:absolute;left:35%;top:188%">
<img src="images copy/emenu12.png" width=400>
</div>
<div style="position:absolute;left:135%;top:-40%">
<img src="images copy/bug.png" width=270>
</div>
<div style="position:absolute;left:-110%;top:-30%">
<img src="images copy/veg.png" width=350>
</div>
</div>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
  ...
  <div class="elem-group inlined">
    <label for="guest">Number of food items :</label>
  ...
  <div class="elem-group">
    <label for="room-selection">food PREFERENCE</label>
    <select id="room-selection" name="setlocation[]" required>
        <option value="">SELECT FOOD ITEMS</option>
        <option value="connecting">HEALTHY FOOD</option>
        <option value="adjoining">INDIAN</option>
        <option value="adjacent">PUNJABI</option>
    </select>
  </div>
  <hr>
  <div class="elem-group">
  ...
  <button type="submit" name="reserv-submit">SUBMIT</button>
<br>
<br>
<br>
<br>
